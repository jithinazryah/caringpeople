...
$related_staff_data = Html::dropDownList('create[related_staffs][' . $count . '][]', $selected_staff, $related_staff, ['class' => 'form-control ', 'prompt' => '--Select--', 'id' => 'create-related_staffs_' . $count, 'multiple' => 'multiple']);

if ($type == 5) {
        $drop = Html::dropDownList('create[related-patient][]', null, ['1' => 'Yes', '0' => 'No'], ['class' => 'form-control']);
        $notification_for_patient = " <div class='col-md-2 col-sm-6 col-xs-12 left_padd'>
                                            <div class='form-group field-followups-related-patient'>
                                               <label class='control-label' for='followups-related-patient'></label>
$drop
