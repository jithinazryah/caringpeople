...
<div class="followups-form form-inline">
        ...
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>
                <?php
                $followup_type = FollowupSubType::find()->where(['type_id' => '2', 'status' => '1'])->all();
...
<?php
$count = Followups::find()->where(['type_id' => $model->id, 'type' => '2'])->count();
if ($count > 0) {
        ?>
        ...
        <div class="row">
                ...
                ListView::widget([
                    ...
                    'itemView' => '_followups',
                    'viewParams' => ['patient_enquiry_id' => $model->id],
                ]);
                ?>
