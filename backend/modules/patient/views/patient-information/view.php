                                                    ...
                                                    <tr>
                                                        <td colspan="3">
                                                            <div class="profile_image" style="float:right;">
                                                                <img src="<?= Yii::$app->homeUrl . '../uploads/patient/' . $patient_details->id . '/guardian_profile_image.' . $guardian_details->guardian_profile_image; ?> " style="width:115px;height:100px;"/>
                                                            </div>
                                                        </td>
