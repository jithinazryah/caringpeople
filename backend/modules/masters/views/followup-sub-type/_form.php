...
<div class="followup-sub-type-form form-inline">
        ...
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'> <?php $folloup_type = FollowupType::find()->all(); ?>  <?= $form->field($model, 'type_id')->dropDownList(ArrayHelper::map($folloup_type, 'id', 'type'), ['prompt' => '--Select--', 'class' => 'form-control']) ?>
