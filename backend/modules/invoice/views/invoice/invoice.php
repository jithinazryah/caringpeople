                            ...
                            <div class="col-md-12">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    foreach ($services as $value) {
                                        ...
                                        $total_amount = $first_estimated_price->price + $added_schedules_amount + $materials_used_amount - $discount_amount - $cancelled_schedules_amount+$registration_fees;
                                        ...
                                        if ($value->registration_fees == 1) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= 'Rs. ' . number_format((float) 1000, 2, '.', ','); ?> </td>
