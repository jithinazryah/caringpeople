...
class ItemMasterController extends Controller {
    ...
    public function actionDelete($id) {
        ...
        $return_details = \common\models\SalesReturnInvoiceDetails::findAll(['item_id' => $id]);
        $purchase_details = \common\models\PurchaseInvoiceDetails::findAll(['item_id' => $id]);

        if (empty($sales_details) && empty($return_details) && empty($purchase_details)) {
