        ...
        <blockquote class="blockquote <?php echo $color; ?>">
                <p>
                        ...
                        <span style="float: right;color: #7c38bc;font-size: 12px;">
                                ...
                                <a href="<?= Yii::$app->homeUrl . 'update-enquiry/' . $client_enquiry_id . '?followup=' . $model->id ?>" title="Edit"> <i class="fa-edit" style="color:#000;margin-left: 10px;font-size: 20px;"></i></a>
                        </span>
                </p>
