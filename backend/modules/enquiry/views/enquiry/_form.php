...
<div class="enquiry-form form-inline">
        ...
        <div class="row">
                ...
                </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd' id='whatsapp_note'>   <?= $form->field($model, 'whatsapp_note')->textarea(['rows' => 2]) ?>
                ...
                </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($other_info, 'priority')->dropDownList(['' => '--Select--', '1' => 'Hot', '2' => 'Warm', '3' => 'Cold']) ?>
