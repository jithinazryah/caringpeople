...
<div class="enquiry-form form-inline">
        ...
        </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd' style="min-height: 150px"> <?= $form->field($model, 'address')->textarea(['rows' => 6]) ?>
        ...
        </div><div class='col-md-2 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'weight')->textInput() ?>
        ...
        </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd' id="service_required_others"> <?= $form->field($model, 'service_required_for_others')->textInput(['maxlength' => true]) ?>

        </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'> <?= $form->field($model, 'veteran_or_spouse')->dropDownList(['' => '--Select--', '1' => 'Yes', '0' => 'No']) ?>

        </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd' style="min-height: 150px;"> <?= $form->field($model, 'person_address')->textarea(['rows' => 6]) ?>
