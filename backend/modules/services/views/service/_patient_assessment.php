...
<div class="patient-bystander-details-form form-inline">
    ...
    <div class='col-md-2 col-sm-6 col-xs-12 left_padd'> <?= $form->field($patient_assessment, 'patient_conscious')->radio(['label' => 'Conscious', 'value' => 1, 'uncheck' => null]) ?></div>
    <div class='col-md-2 col-sm-6 col-xs-12 left_padd'> <?= $form->field($patient_assessment, 'patient_conscious')->radio(['label' => 'UnConscious', 'value' => 2, 'uncheck' => null]) ?></div>
