                                                                                        ...
                                                                                        <?php if (Yii::$app->session['post']['id'] != '5') { ?>
                                                                                                ...
                                                                                                <tr  id="<?= $value->id; ?>" style="text-align:center" >
                                                                                                        ...
                                                                                                        <td>
                                                                                                                ...
                                                                                                                <?php if ($staff_on_duty != '') { ?>  <a target="_blank"  href="<?= Yii::$app->homeUrl ?>/staff/staff-info/choose?branch=<?= $value1->branch_id; ?>&&gender=<?= $value1->gender_preference; ?>&&service=<?= $value1->id; ?>&&type=2&&schedule=<?= $value->id; ?>&&replace=1" id="<?= $value->id; ?>" type="1"  class="staff-allotment <?= $class1 ?>">Replace staff</a><?php } else { ?>
