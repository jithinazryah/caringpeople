                                                                ...
                                                                <table class = "table table-striped">
                                                                        ...
                                                                        <tbody>
                                                                                ...
                                                                                foreach ($designations as $value) {
                                                                                        $k++;
                                                                                        $staffs = StaffInfo::find()->where(['designation' => $value->id])->all();
                                                                                        $amount = 0;
                                                                                        ...
                                                                                        <tr>
                                                                                                ...
                                                                                                <td><?= $value->title; ?></td>
                                                                                                <td><?= 'Rs. ' . $amount . '/-'; ?></td>
                                                                                                <td> <?php if ($amount > 0) { ?><button class="btn btn-info"><a target="_blank" href="<?= Yii::$app->homeUrl ?>attendance/attendance/viewdetails?from=<?= $model->date ?>&to=<?= $model->DOC ?>&type=<?= $value->id ?>" style="color: #FFF">View Details</a></button><?php } ?></td>
