...
<div class="account-head-form form-inline">
        ...
        <div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'ac_holder')->textInput(['maxlength' => true]) ?>
        ...
        </div><div class='col-md-4 col-sm-6 col-xs-12 left_padd'>    <?= $form->field($model, 'ifsc_code')->textInput(['maxlength' => true]) ?>
