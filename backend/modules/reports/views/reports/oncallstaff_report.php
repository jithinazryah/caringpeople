                                                        ...
                                                        <div class = "table-responsive">
                                                                <table class = "table table-striped">
                                                                        ...
                                                                        <tbody>
                                                                                <?php
                                                                                $k = 0;
                                                                                $staffs = StaffInfo::find()->where(['branch_id' => $model->rating])->andWhere(new Expression('FIND_IN_SET(:designation, designation)'))->addParams([':designation' => 1])->orWhere(new Expression('FIND_IN_SET(:designations, designation)'))->addParams([':designations' => 2])->all();
                                                                                $k++;
                                                                                ...
                                                                                <tr>
                                                                                        ...
                                                                                        <td><?= 'Rs. ' . $amount . '/-'; ?></td>
                                                                                        <td> <?php if ($amount > 0) { ?><button class="btn btn-info"><a target="_blank" href="<?= Yii::$app->homeUrl ?>reports/reports/viewdetails?from=<?= $model->date ?>&to=<?= $model->DOC ?>&type=<?= 0 ?>&branch_id=<?= $model->rating ?>" style="color: #FFF">View Details</a></button><?php } ?></td>
                                                                                ...
                                                                                foreach ($designations as $value) {
                                                                                        ...
                                                                                        if ($value->id != 1 && $value->id != 2) {
                                                                                                ...
                                                                                                <tr>
                                                                                                        ...
                                                                                                        <td><?= $value->title; ?></td>
                                                                                                        <td><?= 'Rs. ' . $amount . '/-'; ?></td>
                                                                                                        <td> <?php if ($amount > 0) { ?><button class="btn btn-info"><a target="_blank" href="<?= Yii::$app->homeUrl ?>reports/reports/viewdetails?from=<?= $model->date ?>&to=<?= $model->DOC ?>&type=<?= $value->id ?>&branch_id=<?= $model->rating ?>" style="color: #FFF">View Details</a></button><?php } ?></td>
