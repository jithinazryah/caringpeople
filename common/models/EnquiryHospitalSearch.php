...
class EnquiryHospitalSearch extends EnquiryHospital
{
    ...
    public function rules()
    {
        return [
            ...
            [['hospital_name', 'consultant_doctor', 'hospital_room_no', 'required_service', 'other_services', 'diabetic', 'hypertension', 'tubes', 'feeding', 'urine', 'oxygen', 'tracheostomy', 'iv_line', 'dressing', 'home_or_hospital_visit', 'visit_date', 'bedridden'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'hospital_name', $this->hospital_name])
            ...
            ->andFilterWhere(['like', 'home_or_hospital_visit', $this->home_or_hospital_visit])
