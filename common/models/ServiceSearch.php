...
class ServiceSearch extends Service {
        ...
        public function rules() {
                return [
                        [['id', 'patient_id', 'service', 'staff_type', 'staff_id', 'staff_manager', 'status', 'CB', 'UB', 'day_staff'], 'integer'],
                        [['from_date', 'to_date', 'estimated_price_per_day', 'estimated_price', 'advance_payment', 'DOC', 'DOU', 'day_staff', 'duty_type'], 'safe'],
                ];
        }
