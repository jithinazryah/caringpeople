...
class PatientInformation extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['notes'], 'string'],
            [['status'], 'required'],
            [['contact_address', 'contact_name', 'referral_source', 'contact_mobile_number_1', 'contact_mobile_number_2', 'contact_mobile_number_3', 'contact_zip_or_pc', 'contact_email', 'patient_name', 'other_relationships', 'patient_address', 'patient_city', 'patient_postal_code'], 'string', 'max' => 200],
        ];
    }
