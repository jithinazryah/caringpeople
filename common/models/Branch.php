...
class Branch extends \yii\db\ActiveRecord {
        ...
        public function rules() {
                return [
                        ...
                        [['DOC', 'DOU'], 'safe'],
                    // [['address'], 'text'],
                    [['branch_name', 'branch_code', 'contact_person_name', 'contact_person_number1', 'contact_person_number2', 'contact_person_email', 'bank_account', 'bank_name', 'bank_branch', 'bank_ifsc', 'address'], 'string', 'max' => 280],
                        [['branch_code'], 'unique'],
