                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="" method="post" class="wpcf7-form" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12">
                                        <p><input name="submit" type="submit" value="Send" class="wpcf7-form-control wpcf7-submit"><img class="ajax-loader" src="http://caringpeople.in/wp-content/plugins/contact-form-7/images/ajax-loader.gif" alt="Sending ..." style="visibility: hidden;"></p>
                                    </div>
                                                        ...
                                                        <div id="text-3" class="widget mkdf-footer-column-4 widget_text">
                                                            <div class="textwidget">
                                                                ...
                                                                <form action="#" method="post" class="wpcf7-form cf7_custom_style_1" novalidate="novalidate">
                                                                    ...
                                                                    <p><span class="wpcf7-form-control-wrap your-name"><input type="text" name="first-name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Name*" /></span></p>
                                                                    <p><span class="wpcf7-form-control-wrap your-email"><input type="email" name="email" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email" aria-required="true" aria-invalid="false" placeholder="Email*" /></span></p>
                                                                    <div><span class="wpcf7-form-control-wrap your-message"><textarea name="message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Comment*"></textarea></span></div>
                                                                    <div>
