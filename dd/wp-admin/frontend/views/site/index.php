                                            ...
                                            <ul class="mkdf-portfolio-slider-list" data-columns="3" data-enable-pagination="yes">
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1322 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        ...
                                                        <div class="mkdf-ptfs-item-content">
                                                            ...
                                                            <a href="doctor-visit.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                ...
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1323 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        ...
                                                        <div class="mkdf-ptfs-item-content">
                                                            ...
                                                            <a href="nursing-care.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                ...
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1324 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        <div class="mkdf-ptfs-item-image">
                                                            <a href="#">
                                                                <img width="800" height="600" src="<?= Yii::$app->homeUrl; ?>images/services/caregiving.png" class="attachment-wellspring_mikado_landscape size-wellspring_mikado_landscape wp-post-image" alt="p" /> </a>
                                                        </div>
                                                        <div class="mkdf-ptfs-item-content">
                                                            <div class="mkdf-ptfs-item-icon-holder">
                                                            ...
                                                            <div class="mkdf-ptfs-item-excerpt-holder">
                                                                <p>At Caring People we focus on providing comprehensive physiotherapy services in the comfort and convenience of your own home.</p>
                                                            </div>
                                                            <a href="caregiver-service.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                ...
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1325 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        ...
                                                        <div class="mkdf-ptfs-item-content">
                                                            ...
                                                            <div class="mkdf-ptfs-item-excerpt-holder">
                                                                <p>While other aspects of care, such as personal care, home help, or specialist Alzheimer’s and dementia care,</p>
                                                            </div>
                                                            <a href="under-construction.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                ...
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1327 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        ...
                                                        <div class="mkdf-ptfs-item-content">
                                                            ...
                                                            <div class="mkdf-ptfs-item-excerpt-holder">
                                                                <p>The scope of pharmacy practice includes more traditional roles such as compounding and dispensing medications, and it also includes more modern services related to health care, including clinical services, reviewing medications for safety and efficacy, and providing drug information.</p>
                                                            </div>
                                                            <a href="under-construction.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                ...
                                                <li class="mkdf-ptfs-item-holder mkdf-ptfs-item-with-icon post-1338 portfolio-item type-portfolio-item status-publish has-post-thumbnail hentry portfolio-category-recepies">
                                                    <div class="mkdf-ptfs-item">
                                                        ...
                                                        <div class="mkdf-ptfs-item-content">
                                                            ...
                                                            <div class="mkdf-ptfs-item-excerpt-holder">
                                                                <p>We are flexible. We can organise a hire purchase agreement without the need for a deposit. However, if you would like to pay something upfront, we can organise that option for you as well.</p>
                                                            </div>
                                                            <a href="under-construction.php" target="_self" class="read-more mkdf-btn mkdf-btn-medium mkdf-btn-solid mkdf-btn-hover-outline">
                                                        ...
                                                        <div class="mkdf-testimonial-text-holder">
                                                            <div class="mkdf-testimonial-text-inner light">
                                                                <div class="mkdf-testimonial-slider-image-holder">
                                                                    <img width="122" height="122" src="<?= Yii::$app->homeUrl; ?>images/testimonial/rama.jpg" class="attachment-114 size-114 wp-post-image" alt="p" srcset="images/testimonial/rama.jpg" sizes="(max-width: 122px) 100vw, 122px" /> </div>
                                                ...
                                                <div class="mkdf-testimonial-content-inner">
                                                    <div class="mkdf-container-inner">
                                                        <div class="mkdf-testimonial-text-holder">
                                                            <div class="mkdf-testimonial-text-inner light">
                                                                <div class="mkdf-testimonial-slider-image-holder">
                                                                    <img width="122" height="122" src="<?= Yii::$app->homeUrl; ?>images/testimonial/achan.jpg" class="attachment-113 size-113 wp-post-image" alt="p" srcset="images/testimonial/achan.jpg" sizes="(max-width: 122px) 100vw, 122px" /> </div>
