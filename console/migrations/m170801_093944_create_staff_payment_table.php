...
class m170801_093944_create_staff_payment_table extends Migration {
        ...
        public function up() {
                ...
                $this->createTable('accounts', [
                    'id' => $this->primaryKey(),
                    'branch_id' => $this->integer(),
                    'reference_type' => $this->integer()->comment('1=staff payroll,2=purchase,3=patient invoice,4=patient invoice refund'),
                ...
                $this->createTable('invoice', [
                    ...
                    'due_amount' => $this->decimal(10, 2),
                    'status' => $this->integer()->comment('1=paid,2=unpaid,3=refund'),
                    'due_date' => $this->date(),
                    'payment_date' => $this->date(),
                    'payment_type' => $this->integer(),
                    'reference_no' => $this->string(200),
                    'refund_amount' => $this->decimal(10, 2),
                    'CB' => $this->integer(),
                    'DOC' => $this->date(),
                ]);
