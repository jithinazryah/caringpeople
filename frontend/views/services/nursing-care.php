                                    ...
                                    <div class="wpb_wrapper">
                                        ...
                                        <div class="wpb_column vc_column_container vc_col-sm-12 vc_col-lg-12 vc_col-md-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="mkdf-section-title-holder">
                                                        ...
                                                        <h5 class="clearfix mkdf-title-holder ui-accordion-header ui-state-default ui-corner-all" role="tab" id="ui-id-13" aria-controls="ui-id-14" aria-selected="false" aria-expanded="false" tabindex="-1">
                                                            ...
                                                            <span class="mkdf-tab-title">
                                                                <span class="mkdf-tab-title-inner">
                                                                    Nursing care for respiratory problems (COPD, COAD, pneumonia)
                                                            ...
                                                            <div class="mkdf-accordion-content-inner">
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <ol>
                                                                            <li>Oxygen assessments and therapy</li>
                                                                            <li>Administration of all types of medication</li>
                                                                            <li>Bronchodilators</li>
                                                                            <li>Ventilator support, including BIPAP</li>
                                                                            <li>Supervision of exercise</li>
                                                                            <li>Promotion of independence.</li>
                                                                        </ol>
                                                                        <p>
                                                            ...
                                                            <div class="mkdf-accordion-content-inner">
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <p>
                                                                            Dementia is a common condition that affects a good number of people in our society these days. Risk of developing dementia increases as you get older, it is most prevalent in people over the age of 65. Dementia is a syndrome (a group of related symptoms) associated with an ongoing decline of the brain and its abilities. This includes problems with:
                                                                        </p>
                                                                        <ol>
                                                                            <li>OMemory loss</li>
                                                        ...
                                                        <h5 class="clearfix mkdf-title-holder ui-accordion-header ui-state-default ui-corner-all" role="tab" id="ui-id-13" aria-controls="ui-id-14" aria-selected="false" aria-expanded="false" tabindex="-1">
                                                            ...
                                                            <span class="mkdf-tab-title">
                                                                <span class="mkdf-tab-title-inner">
                                                                    Nursing for people with Diabetes
                                                            ...
                                                            <div class="mkdf-accordion-content-inner">
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <ol>
                                                                            <li>Help with healthy diet</li>
                                                                            <li>Regular meals and drinks to keep you hydrated and balance your blood glucose levels</li>
                                                                            <li>Encouragement to enjoy an active lifestyle which will improve self-care, promote mental health and prevent falls</li>
                                                                            <li>Practical support to manage day-to- day symptoms such as fatigue, blurred vision, hunger and weight loss</li>
                                                                            <li>Assistance with medication and checking your glucose levels</li>
                                                                            <li>Help identifying signs of hypoglycaemia such as: confusion, changes to personality, frequent headaches, speech and self-care difficulties, poor appetite, aggressive behaviour, unsteadiness and falls or loss of consciousness</li>
                                                                            <li>Liaison with our medical team to help you get the best treatment</li>
                                                                            <li>Our care workers are also more than happy to provide a listening ear when you need it. </li>
                                                                        </ol>
                                                                        <p>
                                                                ...
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <ol>
                                                                            ...
                                                                            <li>ECG</li>
                                                                            <li>Serum Glucose and Cholesterol</li>
                                                                            <li>Body Mass Index</li>
                                                                            <li>Other relevant blood tests like Full Blood Count, LFT.</li>
                                                                        </ol>
                                                                        <div class="more-info">
                                                                            <p>For more information please call on +91 9020 599 599 or email us to<a href="#"> info@caringpeople.in</a></p>
                                                                        </div>
                                                                ...
                                                                <div class="wpb_text_column wpb_content_element ">
                                                                    <div class="wpb_wrapper">
                                                                        ...
                                                                        <ol>
                                                                            ...
                                                                            <li>Shaving with an electric razor</li>
                                                                            <li>Oral hygiene</li>
                                                                            <li>Toilet assistance and incontinence care</li>
                                                                        </ol>
                                                                        <div class="more-info">
                                                                            <p>For more information please call on +91 9020 599 599 or email us to<a href="#"> info@caringpeople.in</a></p>
                                                                        </div>
