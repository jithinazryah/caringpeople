                                        ...
                                        <div class="mkdf-menu-area">
                                                <div class="mkdf-grid">
                                                        <div class="mkdf-vertical-align-containers">
                                                                ...
                                                                <!--<li id="nav-menu-item-607" class="menu-item menu-item-type-post_type menu-item-object-page"><?php // Html::a('<span class="item_outer"><span class="item_inner"><span class="item_text">Pharmacy</span></span><span class="plus"></span></span>', ['services/pharmacy'], ['class' => ''])   ?></li>-->
...
<!--                                                                                        <li id="mobile-menu-item-608" class="menu-item menu-item-type-post_type menu-item-object-page"><?php // Html::a('<span class="item_outer"><span class="item_inner"><span class="item_text">Pharmacy</span></span><span class="plus"></span></span>', ['services/pharmacy'], ['class' => ''])  ?></li>-->
